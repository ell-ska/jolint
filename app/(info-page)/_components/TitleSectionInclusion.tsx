const TitleSectionInclusion = () => {
  return (
    <section className='flex max-w-full flex-col pb-20 md:pb-16'>
      <h1 className='text-dark-900 w-full pb-6 font-heading text-3xl font-bold md:text-5xl'>
        Why inclusion is important
      </h1>
      <p className='text-dark-900 w-full font-body text-lg md:max-w-4xl md:text-2xl'>
