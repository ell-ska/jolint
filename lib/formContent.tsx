...
const formContent = [
  ...
  <FormChapter key='chapter-1.1' {...chapters[0][0]} />,
  <FormChapter key='chapter-1.2-done-1' {...chapters[0][1]} />,
  <FormOverview key='overview-2' />,
  <FormChapter key='chapter-2.1-done-2' {...chapters[1][0]} />,
  <FormOverview key='overview-3' />,
  <FormChapter key='chapter-3.1' {...chapters[2][0]} />,
  <FormChapter key='chapter-3.2' {...chapters[2][1]} />,
  <FormChapter key='chapter-3.3-done-3' {...chapters[2][2]} />,
  <FormOverview key='overview-4' />,
  <FormChapter key='chapter-4.1' {...chapters[3][0]} />,
  <FormChapter key='chapter-4.2' {...chapters[3][1]} />,
  <FormSign key='chapter-4.3-sign-done-4' {...chapters[3][2]} />,
